...
reg   [0:0] icmp_ln160_reg_2160;
reg   [0:0] icmp_ln160_reg_2160_pp0_iter1_reg;
reg   [7:0] i_0_reg_285;
...
reg   [0:0] icmp_ln137_reg_2150;
wire   [0:0] icmp_ln160_fu_511_p2;
wire   [9:0] add_ln700_29_fu_1991_p2;
reg   [9:0] add_ln700_29_reg_2179;
reg   [2:0] threshs_m_thresholds_4_reg_2186;
reg   [3:0] threshs_m_thresholds_6_reg_2191;
reg   [4:0] threshs_m_thresholds_8_reg_2196;
...
wire   [9:0] zext_ln186_2_fu_2020_p1;
wire   [0:0] icmp_ln899_1_fu_2023_p2;
wire   [0:0] xor_ln899_1_fu_2028_p2;
wire   [9:0] zext_ln186_3_fu_2038_p1;
wire   [0:0] icmp_ln899_2_fu_2041_p2;
wire   [0:0] xor_ln899_2_fu_2046_p2;
wire   [1:0] zext_ln700_1_fu_2034_p1;
wire   [1:0] zext_ln700_2_fu_2052_p1;
wire   [1:0] add_ln700_30_fu_2056_p2;
wire   [1:0] zext_ln700_fu_2016_p1;
wire   [1:0] tmp_V_fu_2062_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        add_ln700_29_reg_2179 <= add_ln700_29_fu_1991_p2;
        icmp_ln160_reg_2160_pp0_iter1_reg <= icmp_ln160_reg_2160;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln122_fu_320_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        icmp_ln137_reg_2150 <= icmp_ln137_fu_488_p2;
        icmp_ln160_reg_2160 <= icmp_ln160_fu_511_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln160_reg_2160 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        threshs_m_thresholds_4_reg_2186 <= threshs_m_thresholds_2_q0;
        threshs_m_thresholds_6_reg_2191 <= threshs_m_thresholds_1_q0;
        threshs_m_thresholds_8_reg_2196 <= threshs_m_thresholds_q0;
    end
end
...
always @ (*) begin
    if (((icmp_ln160_reg_2160_pp0_iter1_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln160_reg_2160_pp0_iter1_reg == 1'd1) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        out_V_V_TVALID = 1'b1;
    end else begin
        out_V_V_TVALID = 1'b0;
    end
...
assign add_ln700_30_fu_2056_p2 = (zext_ln700_1_fu_2034_p1 + zext_ln700_2_fu_2052_p1);
...
always @ (*) begin
    ap_block_state4_io = ((icmp_ln160_reg_2160_pp0_iter1_reg == 1'd1) & (out_V_V_TREADY == 1'b0));
end
...
assign icmp_ln899_1_fu_2023_p2 = (($signed(add_ln700_29_reg_2179) < $signed(zext_ln186_2_fu_2020_p1)) ? 1'b1 : 1'b0);

assign icmp_ln899_2_fu_2041_p2 = (($signed(add_ln700_29_reg_2179) < $signed(zext_ln186_3_fu_2038_p1)) ? 1'b1 : 1'b0);

assign icmp_ln899_fu_2005_p2 = (($signed(add_ln700_29_reg_2179) < $signed(zext_ln186_1_fu_2002_p1)) ? 1'b1 : 1'b0);
...
assign out_V_V_TDATA = tmp_V_fu_2062_p2;

assign res_V_fu_578_p3 = ((icmp_ln137_reg_2150[0:0] === 1'b1) ? 10'd0 : accu_V_0_0_0_fu_188);
...
assign tmp_V_fu_2062_p2 = (add_ln700_30_fu_2056_p2 + zext_ln700_fu_2016_p1);
...
assign xor_ln899_1_fu_2028_p2 = (icmp_ln899_1_fu_2023_p2 ^ 1'd1);

assign xor_ln899_2_fu_2046_p2 = (icmp_ln899_2_fu_2041_p2 ^ 1'd1);

assign xor_ln899_fu_2010_p2 = (icmp_ln899_fu_2005_p2 ^ 1'd1);

assign zext_ln137_fu_494_p1 = tile_assign_fu_192;

assign zext_ln186_1_fu_2002_p1 = threshs_m_thresholds_4_reg_2186;

assign zext_ln186_2_fu_2020_p1 = threshs_m_thresholds_6_reg_2191;

assign zext_ln186_3_fu_2038_p1 = threshs_m_thresholds_8_reg_2196;

assign zext_ln186_fu_530_p1 = nf_assign_fu_200;

assign zext_ln700_1_fu_2034_p1 = xor_ln899_1_fu_2028_p2;

assign zext_ln700_2_fu_2052_p1 = xor_ln899_2_fu_2046_p2;
