...
(* CORE_GENERATION_INFO="StreamingFCLayer_Batch_0_StreamingFCLayer_Batch_0,hls_ip_2020_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7a50t-fgg484-1,HLS_INPUT_CLOCK=20.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=15.870375,HLS_SYN_LAT=111749,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=252,HLS_SYN_LUT=916,HLS_VERSION=2020_1}" *)
...
wire   [7:0] grp_Matrix_Vector_Activa_fu_34_weights_m_weights_V_address0;
...
StreamingFCLayer_Batch_0_StreamingFCLayer_g8j #(
    .DataWidth( 2 ),
    .AddressRange( 144 ),
    .AddressWidth( 8 ))
...
StreamingFCLayer_Batch_0_Matrix_Vector_Activa grp_Matrix_Vector_Activa_fu_34(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
