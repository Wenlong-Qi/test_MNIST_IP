...
(* CORE_GENERATION_INFO="StreamingFCLayer_Batch_4_StreamingFCLayer_Batch_4,hls_ip_2020_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7a100t-fgg484-1,HLS_INPUT_CLOCK=20.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.644750,HLS_SYN_LAT=605,HLS_SYN_TPT=none,HLS_SYN_MEM=1,HLS_SYN_DSP=0,HLS_SYN_FF=256,HLS_SYN_LUT=745,HLS_VERSION=2020_1}" *)
...
wire   [9:0] grp_Matrix_Vector_Activa_fu_28_weights_m_weights_V_address0;
wire    grp_Matrix_Vector_Activa_fu_28_weights_m_weights_V_ce0;
...
StreamingFCLayer_Batch_4_StreamingFCLayer_dEe #(
    .DataWidth( 2 ),
    .AddressRange( 600 ),
    .AddressWidth( 10 ))
weights_m_weights_0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .address0(grp_Matrix_Vector_Activa_fu_28_weights_m_weights_V_address0),
    .ce0(grp_Matrix_Vector_Activa_fu_28_weights_m_weights_V_ce0),
...
StreamingFCLayer_Batch_4_Matrix_Vector_Activa grp_Matrix_Vector_Activa_fu_28(
    ...
    .weights_m_weights_V_address0(grp_Matrix_Vector_Activa_fu_28_weights_m_weights_V_address0),
    .weights_m_weights_V_ce0(grp_Matrix_Vector_Activa_fu_28_weights_m_weights_V_ce0),
