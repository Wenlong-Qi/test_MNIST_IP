...
assign icmp_ln508_fu_96_p2 = ((t_0_reg_80 == 9'd480) ? 1'b1 : 1'b0);

assign icmp_ln517_fu_129_p2 = ((i_fu_123_p2 == 32'd30) ? 1'b1 : 1'b0);

assign out_V_V_TDATA = p_Result_s_reg_178;

assign p_Result_s_fu_115_p3 = {{tmp_V_fu_111_p1}, {r_V_reg_69}};

assign t_fu_102_p2 = (t_0_reg_80 + 9'd1);

assign tmp_1_fu_140_p4 = {{r_V_reg_69[57:2]}};
